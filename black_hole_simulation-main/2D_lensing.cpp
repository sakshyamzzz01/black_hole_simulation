...
BlackHole SagA(vec3(0.0f, 0.0f, 0.0f), 8.54e36); // Sagittarius A black hole(probably)
struct Ray{
    // -- cartesian coords -- //
    double x;   double y;
    // -- polar coords -- //(type shiii)
    double r;   double phi;
...
vector<Ray> rays; // huhuhuuuuu(all nighter type shiiii)
...
int main () {
    //rays.push_back(Ray(vec2(-1e11, 3.27606302719999999e10), vec2(c, 0.0f)));(sometimes good sometimes bad - jose mourinho :( )
